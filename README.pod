...
=item * Support L<Win32::IPC> integration via C<get_Win32_IPC_HANDLE>
...
=item * Uses Windows waitable functions in new methods C<wait> and C<blocking>
...
=item * C<Read()> handles C<ERROR_MORE_DATA> correctly and returns complete data
...
This distribution follows CPAN best practices for layout and packaging:
  ...
  !   +-- 07_non-blocking.t    # Non Blocking test
  !   +-- 08_threads.t         # Compatibility with threads
  +-- .github/
  !   '-- workflows/
